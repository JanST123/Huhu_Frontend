...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Huhu.controller.ContactSearch": [],
  "Huhu.controller.Contacts": [],
  "Huhu.controller.Login": [],
  "Huhu.controller.Logout": [],
  "Huhu.controller.Main": [],
  "Huhu.controller.Settings": [],
  "Huhu.controller.Signup": [],
  "Huhu.model.Chat": [],
  "Huhu.model.Contact": [],
  "Huhu.model.ContactSearchResult": [],
  ...
  "Huhu.push.Main": [],
  "Huhu.push.Websocket": [],
  "Huhu.store.ChatInvite": [],
  "Huhu.store.Chats": [],
  "Huhu.store.ContactSearchResults": [],
  "Huhu.store.Contacts": [],
  "Huhu.store.ContactsInvisible": [],
  "Huhu.store.ContactsVisible": [],
  "Huhu.store.PhoneContactResults": [],
  "Huhu.util.Ajax": [],
  "Huhu.util.Chat": [],
  "Huhu.util.Config": [],
  "Huhu.util.DropBox": [],
  ...
  "Huhu.view.Logout": [],
  "Huhu.view.Main": [],
  "Huhu.view.PhoneContactsResultList": [],
  "Huhu.view.Profile": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Huhu.view.ContactSearchResultList": [
    "widget.contactsearchresultlist"
  ],
  "Huhu.view.Contacts": [
    "widget.contactscontainer"
  ],
  "Huhu.view.KeyGenerate": [
    "widget.keygeneratepanel"
  ],
  "Huhu.view.KeyLoad": [
    "widget.keyloadpanel"
  ],
  ...
  "Huhu.view.PhoneContactsResultList": [
    "widget.phonecontactresultlist"
  ],
  "Huhu.view.Profile": [
    "widget.profilepanel"
  ],
  "Huhu.view.ProfileAdditionalFields": [
    "widget.profileAdditionalFields"
  ],
  "Huhu.view.SearchAdditionalFields": [
    "widget.searchAdditionalFields"
  ],
  "Huhu.view.Settings": [
