...
Ext.define('Ext.data.Connection', {
    ...
    onUploadComplete: function(frame, options, id) {
        ...
        try {
            ...
            doc=null;
            if (typeof(frame.contentWindow.body)!='undefined') {
            	doc=frame.contentWindow;
            } else if (typeof(frame.contentWindow.document.body)!='undefined') {
            	doc=frame.contentWindow.document;
            } else if (typeof(frame.contentDocument.body)!='undefined') {
            	doc=frame.contentDocument;
            } else if (typeof(window.frames[id].document.body)!='undefined') {
